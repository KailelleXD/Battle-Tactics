...
import { Container, Content, Text, Radio, Left, Right } from "native-base";
        ...
        <View style={styles.modal}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalHeaderText}>
              Unit Information: P{this.props.data.unit.player}-
            ...
            <View style={styles.modalColumn}>
              ...
              <View style={styles.dataLine}>
                ...
                <Text style={styles.dataValue}>
                  {this.props.data.unit.x === 0
                    ? this.props.data.unit.x
                    : this.props.data.unit.x.toFixed(8)}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Y Index: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.y === 0
                    ? this.props.data.unit.y
                    : this.props.data.unit.y.toFixed(8)}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Move: </Text>
                <Text style={styles.dataValue}>{this.props.data.unit.m}</Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Weapon Skill: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.ws ? this.props.data.unit.ws : "N/A"}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Ballistic Skill: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.bs ? this.props.data.unit.bs : "N/A"}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Strength: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.s ? this.props.data.unit.s : "N/A"}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Toughness: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.t ? this.props.data.unit.t : "N/A"}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Wound: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.w ? this.props.data.unit.w : "N/A"}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Attacks: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.a ? this.props.data.unit.a : "N/A"}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Leadership: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.ld ? this.props.data.unit.ld : "N/A"}
                </Text>
              </View>
              <View style={styles.dataLine}>
                <Text style={styles.dataHeader}>Save: </Text>
                <Text style={styles.dataValue}>
                  {this.props.data.unit.sv ? this.props.data.unit.sv : "N/A"}
                </Text>
              </View>
              {/* </Content> */}
            </View>
