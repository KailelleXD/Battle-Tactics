...
export class AppProvider extends React.Component {
  constructor(props) {
    ...
    // iterate thru factions and download all the data, save data to BSData.data
    // display unitsScreen for specific faction
    // save data to phone using AsyncStorage
...
/*
        ...
        const newFaction = {
          name: "Tryanids",
          testData: categoryArr
        }
        BSData.data.factionName = newFaction;  
